...
val JAAS_CF_REQUIRED: AppConfigurationEntry.LoginModuleControlFlag = AppConfigurationEntry.LoginModuleControlFlag.REQUIRED
...
object JAASCustomUsers {
    ...
    fun addUsers(u: List<JAASCredential>) { u.forEach { cred -> users["user_${cred.username}"] = cred.password } }
